...
<h2 align="center" valign="middle">修改商品</h2>
<div class="container">
 <hr/>
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form:form id="inputForm" role="form" action="${ctx}/admin/product/edit"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input minlength="1" required class="form-control" value="${product.title}" type="text" id="title" name="title"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-link">保存</button>
