...
function login() {
    return location.href = "http://localhost:8080/page/userLogin";
}
function regist() {
    return location.href = "http://localhost:8080/page/userReg";
}
...
function search(a) {
    var b = "http://localhost:8080/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
